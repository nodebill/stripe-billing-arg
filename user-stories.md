...
- As an operator, I can open a global invoices screen to review generated invoices across all customers and filter them by status and UTC creation date range.
